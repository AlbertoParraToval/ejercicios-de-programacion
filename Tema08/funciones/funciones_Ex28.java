...
public class funciones_Ex28 {
   ...
   * @author Alberto Parra Toval
   */
  public static void muestraArray(int[] array, int tama�o) {
   ...
   * @author Alberto Parra Toval
   */
  public static void muestraArrayEnTabla(int[] array, int tama�o) {
   ...
   * @author Alberto Parra Toval
   */
  public static int[] generaArrayInt(int tama�o, int maximo, int minimo) {
