...
public class Ex21_28 {
  public static void main(String[] args) {
    ...
    System.out.println("PROGRAMA QUE DEVUELVE EL MÍNIMO DEL ARRAY QUE SE PASA CÓMO PARÁMETRO");
    System.out.println("----------------------------------------------------------------------");
    System.out.println(" ");
    ...
    System.out.println("El número menor es " + funciones.funciones_Ex28.minimoArrayInt(array));
  }
}
