...
public class Ex23_28 {
  public static void main(String[] args) {
    Scanner s = new Scanner(System.in); //declaramos la variable para usar la clase Scanner

    System.out.println("PROGRAMA QUE DEVUELVE LA MEDIA DEL ARRAY QUE SE PASA CÓMO PARÁMETRO");
    System.out.println("----------------------------------------------------------------------");
    System.out.println(" ");
    ...
    //se calcula y se muestra la media del array
    System.out.println("La media del array es " + funciones.funciones_Ex28.mediaArrayInt(array));
  }
}
