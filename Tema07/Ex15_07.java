...
public class Ex15_07 {
    ...
    for (int i = 0; i < 10;i++){
        ocupacion[i] = (int)(Math.random()*5); //maximo de personas por mesa 4
    }
    int clientes = 1;
    int mesaLibre = 0;
    while ( clientes > 0){
        ...
        for (int i = 0; i < 10;i++){ //Numero de la mesa
        ...
        clientes = Integer.parseInt(System.console().readLine()); //El usuario mete cuantas persona son 
